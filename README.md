...
# bootScore
bootScore combines [Bootstrap](https://getbootstrap.com) with the [Underscores](https://underscores.me) theme boiler template to create a compact starter theme for outstanding [WordPress](https://wordpress.org/) projects. It does not include customizer settings, logo upload functionality, or drag-and-drop features. Customization in bootScore is entirely achievable through its `.php`, `.scss`, and `.js` files, requiring basic coding skills for editing. 
