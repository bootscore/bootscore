...
function bootscore_scripts() {
  ...
  if (file_exists(get_template_directory() . '/css/lib/bootstrap.rtl.min.css')) {
    $modificated_bootscoreCss = date('YmdHi', filemtime(get_template_directory() . '/css/lib/bootstrap.rtl.min.css'));
  } else {
...
//  bootscore_compile_scss();
  wp_enqueue_style('bootstrap', get_template_directory_uri() . '/css/lib/bootstrap.rtl.min.css', array(), $modificated_bootscoreCss);
