...
require_once get_template_directory() . '/inc/compiler/scss-compiler.php';           // Picosass compiler
require_once get_template_directory() . '/inc/ts-compiler.php';             // TypeScript compiler
