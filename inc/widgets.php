...
if (!function_exists('bootscore_widgets_init')) :
  ...
  function bootscore_widgets_init() {
    ...
    register_sidebar(array(
      ...
      'id'            => 'top-nav-2',
      'description'   => esc_html__('Add widgets here.', 'bootscore'),
      'before_widget' => '<div class="widget top-nav-widget-2 ' . esc_attr(apply_filters('bootscore/class/header/top-nav-widget-2', 'd-lg-flex align-items-lg-center mt-2 lg:mt-0 lg:ms-2')) . '">',
      'after_widget'  => '</div>',
      'before_title'  => '<div class="widget-title d-none">',
      'after_title'   => '</div>'
    ));
