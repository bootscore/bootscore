...
?>
<!-- wp:group {"metadata":{"name":"c - Hero image left - row h-100 hide-wp-block-classes","categories":["bootscore"],"patternName":"bootscore/hero-img-left"},"className":"row h-100 hide-wp-block-classes","layout":{"type":"default"}} -->
