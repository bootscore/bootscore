...
<div class="wp-block-group container h-100"><!-- wp:group {"metadata":{"name":"c - Hero image left - row h-100 hide-wp-block-classes","categories":["bootscore"],"patternName":"bootscore/c.hero-img-left"},"className":"row h-100 hide-wp-block-classes","layout":{"type":"default"}} -->
