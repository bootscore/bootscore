...
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"s - Heading and subtitle - py-5 bg-body-tertiary hide-wp-block-classes","categories":["bootscore"],"patternName":"section-heading-subtitle"},"className":"py-5 bg-body-tertiary hide-wp-block-classes","layout":{"type":"default"}} -->
...
<p class="mb-0">Some content inside the <code>container</code>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></section>
<!-- /wp:group -->