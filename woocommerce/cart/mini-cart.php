...
<?php else : ?>
  ...
  <p class="woocommerce-mini-cart__empty-message alert alert-info alert-icon alert-info-icon alert-icon"><?php esc_html_e('No products in the cart.', 'woocommerce'); ?></p>
