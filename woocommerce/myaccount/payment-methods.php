...
<?php else : ?>
  ...
  <p class="alert alert-info"><?php esc_html_e('No saved methods found.', 'woocommerce'); ?></p>
...
<?php if (WC()->payment_gateways->get_available_payment_gateways()) : ?>
  <a class="btn btn-outline-primary" href="<?php echo esc_url(wc_get_endpoint_url('add-payment-method')); ?>"><?php esc_html_e('Add payment method', 'woocommerce'); ?></a>
<?php endif; ?>